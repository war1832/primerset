...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { cancha_id: @reserva.cancha_id, cliente_id: @reserva.cliente_id, fecha_baja: @reserva.fecha_baja, fecha_fin: @reserva.fecha_fin, fecha_inicio: @reserva.fecha_inicio }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { cancha_id: @reserva.cancha_id, cliente_id: @reserva.cliente_id, fecha_baja: @reserva.fecha_baja, fecha_fin: @reserva.fecha_fin, fecha_inicio: @reserva.fecha_inicio }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
